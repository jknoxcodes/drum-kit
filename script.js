// A drum kit I created on Sep 3 2019, Day #1 of 30 days of code in the JavaScript30.com class. I learned how to setup code pen, add assets like sound and CSS, about keyboard events, playing audio, a couple methods including querySelector and querySelectorAll, how to edit CSS by using the classList property, and listening for a transitionEnd event.
  
window.onload = function() {window.addEventListener('keydown', playSound)};
